...
public class App extends Application {
    // The main method is the entry point of any Java application. For JavaFX
    // applications,
    ...
    public void start(Stage primaryStage) throws Exception {
        // Create an instance of the CustomerRegister class which will be used to store
        // customers
        ...
        // Set the customer register in the controller to link the UI with the customer
        // registration logic
